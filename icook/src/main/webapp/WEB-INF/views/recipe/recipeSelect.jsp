			...
			<div align="center">
				<table class="table table-hover">
					<thead>
						...
						<tr>
							<td width="20%" style='font-size:40px'>食譜名稱</td>

							<td width="60%" style='font-size:40px'>食譜簡介</td>

							<td width="20%" style='font-size:40px'>查看內容</td>
					...
					<tbody>
						<c:forEach var="recipe" items="${recipeBeans}">
							<tr>
								<td><p align="left">${recipe.recipe_name}</p></td>
								<td><p align="left">${recipe.recipe_summary}</p></td>
								<td><a
