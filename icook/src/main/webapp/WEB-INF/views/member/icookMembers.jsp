...
// 								+"<hr style=clear: both;border-style: dashed;>"
		...
		$("#user_mycollectrecipe").click(function(){
			...
			$("#tag_myForum").css({"border-bottom": "none"});
			$.ajax({
				url : "${pageContext.request.contextPath}/members/page/mycollectrecipe",
				type : "POST",
				dataType : "json",
				data:{member_id:$("#memberId").val()},
				async : true,
	...
	<div class="main">
		...
		<header>
			<sec:authorize access="isAuthenticated()">
				<div class="btn btn-success" onclick="javascript:location.href='${pageContext.request.contextPath}/user'" style="float:right;margin-right:50px;padding-left:35px;min-width:200px;">
